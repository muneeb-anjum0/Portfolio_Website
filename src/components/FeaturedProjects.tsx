...
const FeaturedProjects: React.FC = () => (
  <section id="projects" className="relative py-8 md:py-16 lg:py-20 bg-black text-white overflow-hidden select-none">
    {/* Background Elements */}
    ...
    {/* Terminal Divider */}
    <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-4 sm:pb-6 md:pb-8 pt-6 sm:pt-8 md:pt-12">
