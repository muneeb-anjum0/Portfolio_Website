...
const About = () => {
  ...
  return (
    <section id="about" className="relative py-16 sm:py-20 bg-black text-white overflow-hidden select-none">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          {/* Terminal Info Panel */}
          <div className={`space-y-4 sm:space-y-6 md:space-y-8 transition-all duration-500 order-1 lg:order-2 ${isGlitching ? 'animate-pulse' : ''}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-8 pt-8">
